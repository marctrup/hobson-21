            ...
            <div className="flex justify-between items-center">
              ...
              <div className="relative">
                <Link to="/" onClick={closeMobileMenu}>
                  <OptimizedImage src="/lovable-uploads/hobson-new-logo.png" alt="Hobson AI - AI-powered property management software company logo" className="h-24 md:h-32 w-auto border-2 border-red-500" priority />
                </Link>
              </div>
