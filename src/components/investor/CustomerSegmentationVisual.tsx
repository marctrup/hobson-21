  ...
  const segments = [
    {
      ...
      icon: Building2,
      color: 'from-ink-faint to-charcoal',
      bgColor: 'from-paper to-bone-wash/50 dark:from-ink/30 dark:to-ink/20',
    ...
    },
    {
      ...
      bgColor: 'from-success-bg to-success-bg/50 dark:from-success-solid/30 dark:to-success-solid/20',
