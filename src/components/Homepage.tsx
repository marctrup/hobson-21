              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-4 lg:py-12 -mt-[5px]">
                ...
                <div className="space-y-6 -mt-[20px]">
                  ...
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    Hobson delivers quick, clear, trusted answers with simplicity—saving property professionals time compared to the <strong>bulkier</strong>, overly <strong>complex</strong> and more <strong>costly</strong> alternatives.
                  </p>
