...
const BEATS: Beat[] = [
  ...
  },
  {
    owl: "default",
    lines: [
      "Two things first, because people mix them up — and the difference is everything I do.",
  ...
  },
  {
    ...
    prefill: "And where do the documents fit in?",
    mapAction: "pulse-one",
  },
  {
    owl: "reading",
    lines: [
      "I read two kinds of document. TENANCY documents — leases, licences, assignments, variations, rent reviews — tell me about occupation: who's there and on what terms.",
      "ASSET documents — EPCs, fire risk assessments, valuations, compliance certificates — tell me about the building itself.",
      "Both can belong to a property or a unit. What matters to me isn't where a document is filed — it's what it relates to.",
    ],
    prefill: "How does reading them turn into understanding?",
    mapAction: "pulse-one-doc",
  },
  {
    owl: "default",
    lines: [
      "Rarely does one document tell the whole story. I build understanding by connecting them — a lease, then the variation that changed the rent, then the assignment that changed the tenant.",
      "That understanding becomes Unit Intelligence. Combine the units and I understand the Property. Combine the properties and I understand the whole Portfolio.",
      "That's why nothing attaches directly to a portfolio — portfolio understanding is something I build from the bottom up, not something I'm handed.",
    ],
    prefill: "So what does that let you do for me?",
    mapAction: "pulse-all",
  },
  {
    owl: "talking",
    lines: [
      "Today, I answer your questions and keep your information organised and connected.",
      "But understanding is really there so I can act. When a rent review's due or a certificate's expiring, I'll read the lease, gather what's needed, prepare the work — and bring it to you to approve. You decide; I do the legwork.",
      "That's what I'm growing into: not another app, but a co-worker who helps you get things done. Shall we start?",
    ],
    prefill: "Let's get started",
    mapAction: "check-one",
  },
];
