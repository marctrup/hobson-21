      ...
      <div className="bg-primary/10 border-2 border-primary/30 rounded-lg p-4 lg:p-5">
        ...
        <ul className="space-y-2 text-xs lg:text-sm text-foreground">
          <li className="flex items-start gap-2">
            ...
            <span>A large real estate market of <span className="font-semibold text-primary">235,200 businesses</span></span>
          </li>
          <li className="flex items-start gap-2">
            ...
            <span>Clear segmentation by business size, with 96% being small operators</span>
          </li>
        </ul>
      </div>
    </div>
