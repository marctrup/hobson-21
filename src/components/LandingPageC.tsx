            ...
            <div className="text-white space-y-6 mt-[35px] ml-5">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                  Your AI Assistant, Built for Property documents— <span className="text-purple-300">Free to Try</span>
                </h1>
            ...
            <div className="relative h-[43vh] flex items-start justify-end" style={{ marginRight: '-19px' }}>
              ...
              <div className="relative w-full h-full">
                ...
                <div className="relative z-10 w-full h-full -mt-[2px] flex items-center justify-center">
                  <div className="relative max-w-[440px] max-h-full aspect-[3/4] w-full">
