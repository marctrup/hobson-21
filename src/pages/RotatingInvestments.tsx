      ...
      <div className="w-full max-w-sm sm:max-w-lg">
        ...
        >
          ...
          <div className="absolute bottom-2 sm:bottom-3 md:bottom-4 left-0 right-0 flex items-center justify-between px-2 sm:px-3 md:px-4 pointer-events-none">
            <Button
              ...
              className="rounded-full bg-gradient-to-r from-[#9ca3af] to-[#d1d5db] hover:from-[#6b7280] hover:to-[#9ca3af] w-9 h-9 sm:w-10 sm:h-10 pointer-events-auto touch-manipulation border-0 shadow-lg"
            >
        ...
        <div className="mt-4 sm:mt-6 text-center">
          <Button 
            ...
            className="text-sm sm:text-base px-8 py-3 touch-manipulation bg-gradient-to-r from-[#9ca3af] to-[#d1d5db] hover:from-[#6b7280] hover:to-[#9ca3af] text-primary font-semibold border-0"
          >
            Visit Hobson
          </Button>
        </div>
