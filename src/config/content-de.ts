...
export const CONTENT_DE = {
  ...
  // Pricing Section
  pricing: {
    title: "Einfache Preise. Zahlen Sie für KI-Arbeit — nicht für Benutzer.",
    subtitle: "Unbegrenzte Benutzer. Unbegrenzte Assets. Sie zahlen nur für die KI-Arbeit, die Sie nutzen.",
    ...
    plans: {
      free: {
        name: "Kostenlos",
        price: 0,
        tagline: "Für leichte, gelegentliche KI-Aufgaben.",
      ...
      essential: {
        ...
        priceMonthly: 22.99,
        priceAnnual: 18.50,
        tagline: "Für regelmäßige, wachsende KI-Nutzung.",
        features: ["Alles in Kostenlos, plus:", "Bis zu 20 Dokumente pro Monat hochladen", "Bis zu 100 KI-Fragen pro Monat", "Unbegrenzte Benutzer", "Unbegrenzte Dokumente"],
        boostNote: "Mehr in manchen Monaten nötig?",
        boostDetail: "KI-Boost hinzufügen — €5\n+25 zusätzliche KI-Fragen\nSofortiger Zugang. Kein Planwechsel.",
        boostTagline: "Skalieren Sie Ihre KI-Nutzung ohne Ihren gesamten Plan zu ändern.",
      ...
      enterprise: {
        name: "Enterprise",
        customPricing: true,
        tagline: "Für intensive, tägliche KI-Workflows.",
        features: ["Alles in Essential, plus:", "Flexible Dokumentenlimits", "Flexible KI-Fragenlimits", "Strukturierte Wissensdatenbank", "Dedizierter Support", "Prioritätsverarbeitung"],
        closingNote: "Für Teams, bei denen KI geschäftskritisch ist.",
    ...
    aiBoost: {
      name: "KI-Boost",
      subtitle: "Verfügbar bei kostenpflichtigen Plänen",
      description: "KI-Boost gibt Ihnen zusätzliche KI-Verarbeitung für den aktuellen Abrechnungszeitraum.",
      price: "€5 pro Boost",
      features: ["Stapelbar", "Keine Verpflichtung", "Monatlicher Reset"],
      closingNote: "Ideal für arbeitsreiche Zeiten ohne Bindung an eine höhere Stufe.",
    },
    perMonth: "/Monat",
  },
