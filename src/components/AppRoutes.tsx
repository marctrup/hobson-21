...
const CrmSettingsAuditLog = lazy(() => import("../pages/crm/CrmSettingsAuditLog"));
        ...
        <Routes>
          ...
          {window.location.hostname === 'pilot.hobsonschoice.ai' ? (
            ...
            <>
              ...
              <Route path="/how-hobson-thinks" element={<Navigate to="/#meet-hobson" replace />} />
              <Route path="/How-hobson-thinks" element={<Navigate to="/#meet-hobson" replace />} />
              ...
              <Route path="/crm" element={<CrmGuard><CrmLayout /></CrmGuard>}>
                ...
                <Route path="settings/audit-log" element={<CrmSettingsAuditLog />} />
              </Route>
