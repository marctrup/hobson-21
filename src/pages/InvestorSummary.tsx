      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <section data-pdf-section className="relative min-h-[50vh] sm:min-h-[60vh] flex flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20 overflow-hidden bg-background">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <FileText className="absolute top-8 left-[-15%] w-6 h-6 sm:w-10 sm:h-10 text-primary/40 animate-bounce" style={{ animationDelay: '0ms', animationDuration: '3s' }} />
            <FileText className="absolute top-12 right-[-12%] w-5 h-5 sm:w-8 sm:h-8 text-foreground/30 animate-bounce" style={{ animationDelay: '200ms', animationDuration: '2.5s' }} />
            <FileText className="absolute top-[30%] left-[-17%] w-7 h-7 sm:w-11 sm:h-11 text-foreground/25 animate-bounce" style={{ animationDelay: '400ms', animationDuration: '3.2s' }} />
            <FileText className="absolute top-[35%] right-[-15%] w-6 h-6 sm:w-9 sm:h-9 text-primary/45 animate-bounce" style={{ animationDelay: '600ms', animationDuration: '2.8s' }} />
            <FileText className="absolute bottom-[30%] left-[-12%] w-5 h-5 sm:w-8 sm:h-8 text-primary/40 animate-bounce" style={{ animationDelay: '300ms', animationDuration: '3.1s' }} />
            <FileText className="absolute bottom-[25%] right-[-17%] w-7 h-7 sm:w-10 sm:h-10 text-foreground/30 animate-bounce" style={{ animationDelay: '500ms', animationDuration: '2.9s' }} />
            <FileText className="absolute bottom-16 left-[-15%] w-6 h-6 sm:w-9 sm:h-9 text-foreground/25 animate-bounce" style={{ animationDelay: '700ms', animationDuration: '3s' }} />
            <FileText className="absolute bottom-12 right-[-10%] w-5 h-5 sm:w-7 sm:h-7 text-primary/50 animate-bounce" style={{ animationDelay: '100ms', animationDuration: '2.6s' }} />
            
            {/* Desktop only icons - purple and black 50/50 */}
            <FileText className="hidden sm:block absolute top-6 left-[8%] w-12 h-12 text-foreground/25 animate-bounce" style={{ animationDelay: '400ms', animationDuration: '3.2s' }} />
            <FileText className="hidden sm:block absolute top-14 right-[8%] w-9 h-9 text-primary/45 animate-bounce" style={{ animationDelay: '600ms', animationDuration: '2.8s' }} />
            <FileText className="hidden sm:block absolute top-[22%] left-[2%] w-7 h-7 text-primary/40 animate-bounce" style={{ animationDelay: '500ms', animationDuration: '3.3s' }} />
            <FileText className="hidden sm:block absolute top-[28%] right-[2%] w-10 h-10 text-foreground/30 animate-bounce" style={{ animationDelay: '700ms', animationDuration: '2.7s' }} />
            <FileText className="hidden sm:block absolute top-[45%] left-[-5%] w-6 h-6 text-foreground/25 animate-bounce" style={{ animationDelay: '350ms', animationDuration: '2.4s' }} />
            <FileText className="hidden sm:block absolute top-[42%] right-[-2%] w-8 h-8 text-primary/45 animate-bounce" style={{ animationDelay: '550ms', animationDuration: '3.2s' }} />
            <FileText className="hidden sm:block absolute top-[65%] left-[0%] w-8 h-8 text-primary/40 animate-bounce" style={{ animationDelay: '250ms', animationDuration: '3.1s' }} />
            <FileText className="hidden sm:block absolute top-[68%] right-[5%] w-10 h-10 text-foreground/30 animate-bounce" style={{ animationDelay: '450ms', animationDuration: '2.6s' }} />
            <FileText className="hidden sm:block absolute bottom-20 left-[15%] w-8 h-8 text-foreground/25 animate-bounce" style={{ animationDelay: '450ms', animationDuration: '2.5s' }} />
            <FileText className="hidden sm:block absolute bottom-16 right-[15%] w-9 h-9 text-primary/45 animate-bounce" style={{ animationDelay: '650ms', animationDuration: '3s' }} />
          </div>
