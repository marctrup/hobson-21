      ...
      <div className="w-full max-w-sm sm:max-w-lg">
        ...
        <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden aspect-square">
          ...
          <div className="pt-14 sm:pt-18 pb-16 sm:pb-20 px-4 sm:px-8 h-full flex flex-col">
            <div className="text-center mb-4 sm:mb-6 mt-0 sm:mt-1 flex-shrink-0 border-2 border-blue-500 p-2">
            ...
            <div className="flex-1 flex items-center justify-center -mt-3 border-2 border-green-500 p-2">
