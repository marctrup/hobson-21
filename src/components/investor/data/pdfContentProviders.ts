...
export const getPLAssumptionsPdfContent = (): string[] => [
  ...
  "- Global (OECD markets): 0.2% -> 0.8% penetration (2028-2031)",
...
export const getCapitalRaiseStrategyPdfContent = (): string[] => [
  ...
  "",
  "This raises funds for the full 2026 build year, supports a strong UK commercial",
  "launch in 2027, and establishes Hobson as the category-defining intelligence",
  "layer for Real Estate operations.",
  "",
  "The £5M raise is calibrated for optimal execution: accelerated product velocity,",
  "full go-to-market activation, early enterprise engagement, and controlled",
  "international readiness.",
  "",
  "This capital establishes readiness, not loss coverage.",
  "",
  "WHAT THE CAPITAL UNLOCKS:",
  "- Foundational Team (from June 2026): Core commercial and product leadership ahead of launch.",
  "- Production-Ready Platform: Completion of ingestion engine, AI scaling, UI/UX, quality systems, security hardening, and release engineering.",
  "- Go-to-Market Activation: Brand development, funnel creation, messaging, early campaigns, and systematic conversion of pilots into contracted recurring revenue.",
  "",
  "USE OF FUNDS (planned deployment of £5M):",
  "",
  "Category                      | Allocation   | Description",
  "Product & Engineering         | £2,000,000   | Core platform build, data pipelines, reliability/security, roadmap delivery.",
  "Sales & Marketing             | £1,750,000   | Initial GTM engine: sales and marketing hires, marketing foundations, pipeline build.",
  "Operations / G&A              | £750,000     | Finance/legal, customer success coverage, tools, basic corporate infrastructure.",
  "Data / Compliance / Security  | £250,000     | Enterprise readiness: security hardening, policies, light-touch audits.",
  "Contingency                   | £250,000     | Execution buffer for hiring delays, timing variance, and unforeseen costs.",
  "-------------------------------------------------------------------",
  "Total use of funds            | £5,000,000   | Sum of allocations above",
  "",
...
export const getRevenueGrowthPdfContent = (): string[] => [
  ...
  "UK revenue: Enterprise        | £0   | £208,096  | £832,385    | £1,872,866   | £3,537,636   | £5,930,743",
  "UK revenue: Enterprise Plus   | £0   | £418,294  | £627,442    | £976,020     | £1,533,746   | £2,335,478",
  "UK revenue: Essential         | £0   | £81,977   | £163,955    | £300,583     | £519,190     | £833,436",
  "UK Total revenue              | £0   | £708,368  | £1,623,781  | £3,149,470   | £5,590,573   | £9,099,657",
  "",
  "Global revenue: Enterprise      | £0 | £0 | £1,413,780  | £5,655,122   | £8,482,683   | £22,620,488",
  "Global revenue: Enterprise Plus | £0 | £0 | £2,841,842  | £11,367,366  | £28,418,416  | £56,836,832",
  "Global revenue: Essential       | £0 | £0 | £556,944    | £2,227,775   | £5,569,438   | £11,138,877",
  "Global Total revenue            | £0 | £0 | £4,812,566  | £19,250,264  | £42,470,537  | £90,596,196",
  "",
  "TOTAL REVENUE                   | £0 | £708,368  | £6,436,347  | £22,399,734  | £48,061,110  | £99,695,853",
  "",
  "Key Growth Drivers:",
  "- UK market penetration: 0.5% -> 1.8% (2027-2031)",
  "- Global expansion begins 2028 with 0.2% penetration",
  "- Global penetration grows to 0.8% by 2031",
  "- Blended ARPU: GBP 607/year",
  "",
  "Revenue Mix Evolution:",
  "- 2027: 100% UK (market launch year)",
  "- 2028: ~25% UK, ~75% Global (expansion year)",
  "- 2031: ~9% UK, ~91% Global (scaled operations)",
  "",
...
export const getPLAssumptionsDetailedStructuredData = () => ({
  ...
  revenueModel: {
    ...
    customerGrowth: {
      ukPenetration: "0.5% -> 1.8% (2027-2031)",
      globalPenetration: "0.2% -> 0.8% (2028-2031)",
