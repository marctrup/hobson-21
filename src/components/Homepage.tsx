            ...
            <div className="flex justify-between items-center">
              ...
              <div className="relative">
                <Link to="/" onClick={closeMobileMenu}>
                  <OptimizedImage src="/lovable-uploads/hobson-new-logo.png" alt="Hobson AI - AI-powered property management software company logo" className="h-12 md:h-16 w-auto border-2 border-red-500" priority />
                </Link>
              </div>
