      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        <div className="space-y-4">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-danger-bg border border-danger-border rounded-full text-danger text-sm font-medium mb-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-danger-bg rounded-lg border border-danger-border">
              <AlertTriangle className="w-4 h-4 text-danger" />
              <span className="text-sm text-danger font-medium">Prone to errors</span>
            </div>
          </div>
          ...
          <div className="bg-muted/30 rounded-lg p-4 text-center">
            <div className="text-xs text-muted-foreground space-y-1">
              ...
              <div className="text-danger font-medium">2-3 hours needed</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-success-bg border border-success-border rounded-full text-success text-sm font-medium mb-4">
          ...
          {/* Instant result */}
          <div className="bg-gradient-to-br from-success-bg to-success-bg rounded-lg p-6 border border-success-border shadow-lg">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2 text-xs">
                ...
                <span className="text-success">Lease Agreement (Page 5, Clause 3.2)</span>
              </div>
              <div className="flex items-start gap-2 text-xs">
                <CheckCircle className="w-3 h-3 text-success mt-0.5 flex-shrink-0" />
                <span className="text-success">Deed of Variation (Page 2, Clause 1.1)</span>
              </div>
            </div>

            <div className="mt-4 pt-4 border-t border-success-border">
