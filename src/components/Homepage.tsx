              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-4 lg:py-12 -mt-[5px]">
                ...
                <div className="space-y-6 -mt-[20px]">
                  <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                    <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Skip bulky, overly complex, expensive systems—</span>
                    <span className="text-foreground">choose the simplicity of Hobson.</span>
                    <FileHeart className="inline ml-2 h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-primary/70" />
                  </h1>
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    AI-powered document insights from the only reliable source of truth—your documents. <span className="text-primary font-semibold">Hobson</span> delivers quick, clear, trusted answers with simplicity, saving property professionals time versus bulkier, more complex and costly alternatives.
                  </p>
