      ...
      <section className="relative min-h-[48vh] flex items-center overflow-hidden">
        ...
        <div className="relative container mx-auto pl-4 pr-0 max-w-7xl h-[48vh] flex flex-col">
          <div className="flex-1 grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="text-white space-y-6 mt-[70px] ml-5">
              
              {/* Main Heading */}
              <div className="space-y-4">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                  Your AI Assistant, Built for Property documents— <span className="text-green-300">Free to Try</span>
                </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="text-xl text-gray-600 space-y-6 max-w-4xl mx-auto leading-relaxed">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Why We're Doing This</h3>
                <p>
