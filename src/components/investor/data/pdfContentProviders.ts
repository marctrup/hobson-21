...
export const getExecutiveSummaryPdfContent = (): string[] => [
  ...
  "In real estate AI, the hardest problem is not intelligence - it is earning",
  "permission to use it. Clients are sceptical by default. Hobson's proprietary",
  "advantage is knowing how to earn that permission, repeatedly, at scale.",
  "",
  "MARKET OPPORTUNITY:",
  "- UK: GBP 1.41B",
  "- Europe: GBP 15.5B",
