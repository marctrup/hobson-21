...
export const getBrandStrategyPdfContent = (): string[] => [
  "BRAND STRATEGY",
  "",
  "Hobson's brand strategy is built on authenticity, clarity, and trust. Every touchpoint reinforces our position as the calm, intelligent guide that brings clarity to document chaos - without disruption, hype, or complexity.",
  "",
  "BRAND POSITIONING:",
  "",
  "Tagline: Innovation Without Disruption",
  "Archetype: The Sage",
  "Brand Promise: Instant, referenced answers from your property documents",
  "Key Differentiation: The only AI built specifically for real estate document intelligence",
  "",
  "BRAND PILLARS:",
  "",
  "1. Clarity:",
  "Every interaction should reduce confusion and deliver instant understanding.",
  "- Referenced answers that can be verified",
  "- Simple, jargon-free language",
  "- Transparent pricing and processes",
  "",
  "2. Trust:",
  "Build confidence through honesty, accuracy, and reliability.",
  "- Never overstate capabilities",
  "- Acknowledge limitations openly",
  "- Consistent delivery on promises",
  "",
  "3. Simplicity:",
  "Remove friction at every touchpoint - innovation without disruption.",
  "- Zero-onboarding experience",
  "- Works alongside existing tools",
  "- Intuitive, clean interface",
  "",
  "4. Accessibility:",
  "AI intelligence available to every real estate operator, regardless of size.",
  "- Affordable pricing tiers",
  "- No technical expertise required",
  "- Scales with business needs",
  "",
  "BRAND PERSONALITY:",
  "- Calm: Quiet confidence, never pushy or aggressive",
  "- Knowledgeable: Deep expertise delivered with humility",
  "- Helpful: Genuinely focused on solving problems",
  "- Honest: Transparent about what we can and cannot do",
  "- Friendly: Approachable and easy to work with",
  "",
  "VISUAL IDENTITY ELEMENTS:",
  "",
  "The Owl Mascot:",
  "The owl embodies wisdom, observation, and guidance - watching over your documents to deliver clarity.",
  "",
  "Purple Palette:",
  "Purple signifies insight, innovation, and clear thinking - setting Hobson apart from traditional PropTech.",
  "",
  "HUE System:",
  "Hobson Energy Units (HUEs) create transparency in usage and provide a gamified engagement layer.",
  "",
  "BRAND VOICE PRINCIPLES:",
  "",
  "Explain, Don't Sell:",
  "Do: We help you find answers in your documents",
  "Avoid: Revolutionary AI transforms your business",
  "",
  "Be Specific:",
  "Do: Answers include page references",
  "Avoid: Smart document analysis",
  "",
  "Stay Humble:",
  "Do: We're still learning",
  "Avoid: The ultimate solution",
  "",
  "Focus on Outcomes:",
  "Do: Save 2 hours per week on document search",
  "Avoid: Cutting-edge technology",
  "",
  "CORE BRAND METAPHORS:",
  "",
  "GPS for Documents:",
  "Hobson guides you directly to the information you need, just like GPS guides you to your destination.",
  "",
  "Desk Lamp of Truth:",
  "Hobson illuminates what's in your documents, shining light on hidden details and forgotten clauses.",
  "",
  "Wise Owl Advisor:",
  "Like an owl watching over your portfolio, Hobson observes, understands, and offers guidance when needed.",
  "",
