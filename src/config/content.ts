...
export const CONTENT = {
  ...
  hero: {
    ...
    strapline: "ChatGPT may read a lease, but Hobson understands the unit.",
  ...
  // Pricing Section
  pricing: {
    title: "Simple pricing. Pay for AI work — not users.",
    subtitle: "Unlimited users. Unlimited assets. You only pay for the AI work you use.",
    ...
    plans: {
      free: {
        name: "Free",
        price: 0,
        tagline: "For light, occasional AI tasks.",
      ...
      enterprise: {
        name: "Enterprise",
        customPricing: true,
        tagline: "For high-volume, daily AI workflows.",
        features: ["Everything in Essential Plus, plus:", "Flexible document limits", "Flexible AI question limits", "Dedicated support", "Priority processing"],
        closingNote: "Built for teams where AI is business-critical.",
    ...
    aiBoost: {
      name: "AI Boost",
      subtitle: "Available on Paid Plans",
      description: "AI Boost gives you additional AI processing for the current billing cycle.",
      price: "£5 per Boost",
  ...
  navigation: {
    links: [
      { to: "/how-hobson-thinks", label: "How Hobson Thinks", title: "How Hobson thinks and works" },
