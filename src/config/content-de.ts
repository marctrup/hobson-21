  ...
  pricing: {
    ...
    plans: {
      free: {
        ...
        features: ["Alle Funktionen", "Unbegrenzte Benutzer", "Unbegrenzte Dokumente"],
      ...
      essential: {
        ...
        priceAnnual: 18.40,
        heus: 275,
        tagline: "Für stetige monatliche Arbeitslasten.",
        features: ["Alles in Kostenlos", "Prioritäts-Support"],
      ...
      enterprise: {
        ...
        features: ["Alles in Plus", "Wissensdatenbank erstellen", "Dedizierter Support"],
