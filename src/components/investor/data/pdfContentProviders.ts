...
export const getExecutiveSummaryPdfContent = (): string[] => [
  ...
  "",
  "Hobson is building the cornerstone of accurate document intelligence for",
  "commercial real estate.",
  "",
  "We deliver AI-driven reasoning directly from source documents, with full",
  "traceability and auditability, inside the workflows operators already use.",
  "",
  "This unlocks:",
  "- Faster decisions",
  ...
  "",
  "Once document intelligence is trusted, it becomes the foundation for automation,",
  "optimisation, and entirely new AI-led products across the real estate stack.",
  "Hobson is the entry point to that expansion.",
  "",
  "What starts as document reasoning becomes decision infrastructure.",
  "",
  "THE OPPORTUNITY:",
  "",
  "This is a rare chance to back a platform that begins with accuracy and trust -",
  "and grows into a system of record for AI in real assets.",
  "",
  "MARKET OPPORTUNITY:",
  "- UK: GBP 1.41B",
  "- Europe: GBP 15.5B",
