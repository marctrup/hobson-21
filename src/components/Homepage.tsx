          ...
          <section className="py-8 md:py-16">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div>
                  <div className="mb-8">
                    <h2 className="text-4xl md:text-5xl font-bold mb-2 text-foreground">How It Works</h2>
                ...
                <div>
                  <div className="w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[506px]">
                    <div className="mb-8">
                      <h2 className="text-4xl md:text-5xl font-bold mb-2 text-foreground">Meet Georgia</h2>
