  ...
  return (
    <div className="h-full flex flex-col justify-center px-2 sm:px-4" style={{ height: '100%', minHeight: '200px' }}>
      <div className="text-center space-y-3 sm:space-y-4">
        <div className="text-xs sm:text-sm md:text-base font-semibold text-foreground px-2 leading-tight">
        ...
        <div className="flex items-center justify-center">
          <OptimizedImage
            ...
            className="rounded-lg shadow-lg max-w-full h-auto w-full max-w-[192px] sm:max-w-[240px] md:max-w-[288px] object-contain"
            width={400}
            height={400}
            priority={true}
          />
