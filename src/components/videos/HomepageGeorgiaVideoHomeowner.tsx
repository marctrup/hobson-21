...
export const HomepageGeorgiaVideoHomeowner = () => {
  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-4xl p-0 border-0" id="homepage-georgia-video-dialog-homeowner">
          <div className="aspect-video">
            {videoLoaded ? (
              <iframe 
                ...
                allowFullScreen 
                loading="lazy"
                id="homepage-georgia-video-iframe-homeowner"
              />
            ) : (
