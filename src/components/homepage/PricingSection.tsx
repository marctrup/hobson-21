...
export const PricingSection = () => {
  ...
  return (
    <section id="pricing-section" className="py-16 md:py-24 bg-gradient-to-br from-background to-purple-50/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Choose Your AI Journey</h2>
        ...
        {/* Pricing Plans Grid */}
        <div className="grid gap-6 lg:grid-cols-4 md:grid-cols-2 max-w-7xl mx-auto items-stretch">
