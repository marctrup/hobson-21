...
export const CONTENT_AE = {
  ...
  howItWorks: {
    title: "How It Works",
    subtitle: "No more complicated menus - simply ask questions and gain insights",
    steps: [
      {
  ...
  pricing: {
    ...
    plans: {
      free: {
        ...
        features: ["All features", "Upload up to 2 documents", "Ask up to 5 questions per month", "Unlimited users", "Unlimited documents"],
        button: "Start Free",
