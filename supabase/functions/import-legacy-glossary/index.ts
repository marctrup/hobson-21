...
const LEGACY_GLOSSARY = [
  ...
  { term: "AMD (Accompanying and Modification Document)", definition: "Documents that modify, extend, or support an RTO. This includes formal amendments (deeds of variation, rent memorandums) and supporting documents (notices, identity documents, funding documents).", category: "Document Types", sort_order: 6 }, "Documents that modify, extend, or support an RTO. This includes formal amendments (deeds of variation, rent memorandums) and supporting documents (notices, identity documents, funding documents).", category: "Document Types", sort_order: 6 },
