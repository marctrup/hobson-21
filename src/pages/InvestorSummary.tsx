      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <section className="relative min-h-[50vh] sm:min-h-[60vh] flex flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <FileText className="absolute top-[35%] right-[5%] w-6 h-6 sm:w-9 sm:h-9 text-[#2AB6B6]/45 animate-bounce" style={{ animationDelay: '600ms', animationDuration: '2.8s' }} />
            <FileText className="absolute bottom-[30%] left-[8%] w-5 h-5 sm:w-8 sm:h-8 text-[#2AB6B6]/50 animate-bounce" style={{ animationDelay: '300ms', animationDuration: '3.1s' }} />
            <FileText className="absolute bottom-[25%] right-[3%] w-7 h-7 sm:w-10 sm:h-10 text-[#2AB6B6]/40 animate-bounce" style={{ animationDelay: '500ms', animationDuration: '2.9s' }} />
            ...
            <FileText className="hidden sm:block absolute top-[28%] right-[22%] w-10 h-10 text-[#2AB6B6]/40 animate-bounce" style={{ animationDelay: '700ms', animationDuration: '2.7s' }} />
            <FileText className="hidden sm:block absolute top-[45%] left-[15%] w-6 h-6 text-[#2AB6B6]/60 animate-bounce" style={{ animationDelay: '350ms', animationDuration: '2.4s' }} />
            <FileText className="hidden sm:block absolute top-[42%] right-[18%] w-8 h-8 text-[#2AB6B6]/50 animate-bounce" style={{ animationDelay: '550ms', animationDuration: '3.2s' }} />
            <FileText className="hidden sm:block absolute top-[65%] left-[20%] w-8 h-8 text-[#2AB6B6]/50 animate-bounce" style={{ animationDelay: '250ms', animationDuration: '3.1s' }} />
            <FileText className="hidden sm:block absolute top-[68%] right-[25%] w-10 h-10 text-[#2AB6B6]/40 animate-bounce" style={{ animationDelay: '450ms', animationDuration: '2.6s' }} />
            <FileText className="hidden sm:block absolute bottom-20 left-[35%] w-8 h-8 text-[#2AB6B6]/50 animate-bounce" style={{ animationDelay: '450ms', animationDuration: '2.5s' }} />
            <FileText className="hidden sm:block absolute bottom-16 right-[35%] w-9 h-9 text-[#2AB6B6]/45 animate-bounce" style={{ animationDelay: '650ms', animationDuration: '3s' }} />
          </div>
