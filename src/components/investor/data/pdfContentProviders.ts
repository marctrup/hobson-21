...
export const getPrimaryConversionChannelsPdfContent = (): string[] => [
  ...
  "",
  "The three channels work together to create a coherent journey:",
  "1. Website: Education, credibility, and entry point for deeper engagement",
  "2. Quiz: Low-friction engagement, insight gathering, and emotional connection",
  "3. Product: Demonstration of value through real document interaction",
  "",
  "CHANNEL 1: WEBSITE (hobsonschoice.ai)",
  "",
  "The website is the primary conversion channel for prospects who want to understand what Hobson does before engaging further.",
  "",
  "Role in Conversion:",
  "- Explain what Hobson does in clear, accessible terms",
  "- Build credibility through case examples and pilot stories",
  "- Provide a clear path to the quiz or pilot enquiry",
  "- Support SEO and AI search discoverability",
  "",
  "Key Conversion Elements:",
  "- Clear product explanation on homepage",
  "- Role-specific pages (COO, Asset Manager, Owner-Manager)",
  "- Case summaries with measurable outcomes",
  "- Simple pilot enquiry form",
  "",
  "Website Conversion Targets:",
  "- 40% traffic increase by Q4 2027",
  "- 2+ min average dwell time by Q4 2026",
  "- 5% visitor-to-enquiry rate target",
  "- 10 educational pieces by Q4 2026",
  "",
  "CHANNEL 2: THE QUIZ",
  "",
  "The quiz is designed as a low-friction entry point that introduces the problem space, gathers light insights, and creates an early emotional connection.",
  "",
  "Purpose:",
  "- Help prospects recognise their own pain points",
  "- Provide immediate, personalised value",
  "- Capture contact details for follow-up",
  "- Segment users by role and need",
  "",
  "Experience:",
  "- Short, engaging format (2-3 minutes)",
  "- Interactive, not passive",
  "- Clear visual results at the end",
  "- Natural path to next step",
  "",
  "Outcomes:",
  "- Lead capture with context",
  "- Qualification by role/need",
  "- Warm handoff to pilot or product",
  "- Data for content improvement",
  "",
  "Quiz Conversion Targets:",
  "- 500+ completions by Q2 2027",
  "- 30% completion-to-lead rate",
  "- 15% lead-to-pilot enquiry rate",
  "",
  "CHANNEL 3: THE PRODUCT (Free Entry Point)",
  "",
  "The product itself is a conversion channel. The free tier allows prospects to experience Hobson with their own documents.",
  "",
  "Free Tier Conversion Logic:",
  "- Remove the barrier of commitment before value is proven",
  "- Let users experience real answers from their own documents",
  "- Build habit and trust before any payment discussion",
  "- Create natural upgrade triggers through usage limits",
  "",
  "In-Product Conversion Elements:",
  "- Clear onboarding that shows value in first session",
  "- Usage prompts that guide without interrupting",
  "- Transparent referencing builds trust",
  "- Soft upgrade prompts at natural moments",
  "",
  "Product Conversion Targets:",
  "- 60% first-session success rate",
  "- 40% return within 7 days",
  "- 20% free-to-paid conversion",
  "- 3 avg queries before upgrade",
  "",
  "CONVERSION FLOW INTEGRATION:",
  "",
  "The three channels connect in a natural flow:",
  "Website (Discover & Learn) -> Quiz (Engage & Qualify) -> Product (Experience & Convert)",
  "",
  "Prospects can enter at any point and progress naturally toward product usage.",
  "",
  "CONTINUOUS OPTIMISATION:",
  "",
  "Website: Page performance analytics, heat mapping, form completion rates, A/B testing",
  "Quiz: Completion rates by question, drop-off analysis, result-to-action conversion, lead scoring",
  "Product: First-session behaviour, feature adoption, upgrade triggers, churn identification",
  "",
  "SMART CONVERSION TARGETS (2026-2027):",
  "- 40% website traffic increase by Q4 2027",
  "- 500+ quiz completions by Q2 2027",
  "- 5% website visitor-to-enquiry rate",
  "- 30% quiz completion-to-lead rate",
  "- 20% free-to-paid product conversion",
  "- 60% first-session success rate",
  "",
  "These three channels form a connected conversion system that reduces friction, demonstrates value early, and supports a natural progression from curiosity to active use.",
];
