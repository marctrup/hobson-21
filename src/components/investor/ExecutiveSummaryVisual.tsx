        ...
        <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50/80 to-orange-50/80 dark:from-amber-950/20 dark:to-orange-950/20 border border-amber-200/50 dark:border-amber-800/30">
          <div className="flex flex-wrap gap-4 justify-between items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 text-xs font-medium rounded-full bg-white/80 dark:bg-white/10 text-foreground border border-amber-200/50 dark:border-amber-700/30">
                No per-user fees
              </span>
              <span className="px-3 py-1 text-xs font-medium rounded-full bg-white/80 dark:bg-white/10 text-foreground border border-amber-200/50 dark:border-amber-700/30">
                No per-asset fees
