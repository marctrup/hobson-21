    ...
    <HelmetProvider>
      <div className="min-h-screen" style={{ background: '#FCFAF7' }}>
        <Helmet>
          ...
          <meta name="description" content="Notes from our desk — what we have learned from working with our clients, operators, occupiers and owners of real estate." />
          ...
          <meta property="og:description" content="Notes from our desk — what we have learned from working with our clients, operators, occupiers and owners." />
          ...
          <meta name="twitter:description" content="Notes from our desk — what we have learned from working with our clients, operators, occupiers and owners." />
