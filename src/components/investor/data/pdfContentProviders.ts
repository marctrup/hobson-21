...
export const getBrandIntegrityPdfContent = (): string[] => [
  ...
  "",
  "Brand Summary:",
  "Hobson has a clear, coherent, and authentic brand foundation.",
  "Voice, visual identity, archetypes, and interactive elements convey",
  "calm intelligence and dependable guidance.",
  "",
  "Next Phase: Scaling emotional storytelling, building structured support,",
  "demonstrating move from retrieval to proactive insight.",
  "",
  "Brand Background:",
  "- Calm, intelligent, dependable AI assistant for Real Estate",
  "- Stands for clarity, trust, and simplicity",
  "- Primary archetype: Sage (wisdom, guidance, truth)",
  "- Supporting: Ruler (order, reliability) and Creator (innovation)",
  "- Purple palette signals insight and clear thinking",
  "- Owl mascot embodies quiet, observant guide",
  "",
  "Brand Strengths:",
  "- Simplifies document retrieval, reduces cognitive load",
  "- Saves time on routine information search",
  "- Provides transparent, referenced answers",
  "- Calm, clear, jargon-free tone",
  "",
  "Brand Weaknesses (Opportunities):",
  "- Emotionally not yet fully expressed",
  "- Seen as reliable but not yet strategic insight source",
  "- Building resolution and support structures",
  "",
  "Emotional Appeal: Reassurance - reduces stress, gives control",
  "Cognitive Appeal: Measurable outcomes, transparent referencing",
  "",
  "Authenticity: Avoids hype, open about limitations, clarity not mystery",
  "",
  "Brand Metaphors:",
  "- GPS for documents - straight to the answer",
  "- Master key - unlocks hidden information",
  "- Compass in document jungle - navigates complexity",
  "- Desk lamp - quietly illuminates truth",
  "",
  "Current Position: Selective, relationship-led presence",
  "Opportunity: Become confident, educational voice shaping expectations",
];
