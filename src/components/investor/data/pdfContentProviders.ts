...
export const getExecutiveSummaryPdfContent = (): string[] => [
  ...
  "",
  "Manual document work is now a structural bottleneck in real estate - driving cost,",
  "hidden risk, and slow decisions as portfolios scale and regulation tightens.",
  "",
  "Most AI platforms fail here for two reasons. They demand system replacement - and",
  "operators say 'nooooo'. The risk is too high and systems are too embedded. They",
  "also prioritise speed over truth. AI that cannot prove where answers come from is",
  "not trusted. In this market, speed without accuracy is a liability.",
  "",
  "Hobson is built for these realities. We embed into existing workflows, start at",
  "the document layer - the source of truth - and deliver auditable, traceable",
  "reasoning. Our architecture and pricing are designed to earn trust first, then",
  "expand. Replacement only happens when it is safe and inevitable.",
  "",
  "Trust is the gate to the GBP 155B opportunity. Hobson earns it - then unlocks it.",
  "",
  "Proprietary Advantage (The Real Moat):",
  "Our moat is earned, not claimed.",
  "Through repeated architectural pivots and live operator use, Hobson has learned",
  "how to earn trust inside real estate workflows. That execution knowledge compounds",
  "faster than competitors can copy - and is what unlocks adoption at scale.",
  "",
  "Addressable Market - Annual Efficiency Value Unlocked:",
  "- UK: GBP 1.41B",
  "- Europe: GBP 15.5B",
  "- Global: GBP 155.6B",
  "",
