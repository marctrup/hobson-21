    ...
    <div className="flex justify-center">
      ...
      >
        <DialogTrigger asChild>
          <div
            className={`cursor-pointer relative w-80 h-52 bg-black rounded-lg overflow-hidden shadow-lg border-[11px] border-white transition-all duration-700 transform ${
