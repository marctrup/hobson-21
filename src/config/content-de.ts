...
export const CONTENT_DE = {
  ...
  pricing: {
    ...
    subtitle: "Beginnen Sie kostenlos, skalieren Sie nach Bedarf",
    free: {
      title: "Kostenlos",
      price: "£0",
      period: "/Monat",
      description: "Perfekt zum Ausprobieren von Hobson",
      features: [
    ...
    pro: {
      ...
      price: "£49",
      period: "/Monat",
      description: "Für wachsende Immobilienunternehmen",
      features: [
