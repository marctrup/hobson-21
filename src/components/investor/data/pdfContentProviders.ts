...
export const getExecutiveSummaryPdfContent = (): string[] => [
  ...
  "Hobson is the intelligence layer real estate operations run on. We replace manual",
  "document work with AI-driven reasoning—delivering instant, auditable answers that",
  "cut staffing costs, reduce risk, and accelerate decisions, without disrupting",
