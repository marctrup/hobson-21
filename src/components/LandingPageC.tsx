  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-primary/5">
      ...
      <section className="relative min-h-[43vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-ink-faint via-ink-faint to-bone"></div>
            ...
            <div className="text-white space-y-6 mt-[35px] ml-5">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                  Your AI Assistant, Built for Property documents— <span className="text-ink-faint">Free to Try</span>
                </h1>
                  ...
                  <div className="relative max-w-[532px] max-h-full aspect-[3/4] w-full">
                    ...
                    <div className="absolute bottom-8 left-[182px]">
                      <button 
                        ...
                        className="w-16 h-16 bg-bone rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform"
                        aria-label="Play video"
                      >
                        <div className="w-0 h-0 border-l-[16px] border-l-ink border-y-[12px] border-y-transparent ml-1"></div>
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="mb-12">
              <Button 
                ...
                className="bg-success hover:bg-success text-white font-semibold px-8 py-4 text-lg rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl"
            ...
            <div className="text-xl text-charcoal space-y-6 max-w-4xl mx-auto leading-relaxed">
              <div>
                <h3 className="text-2xl font-bold text-charcoal mb-4">Why We're Doing This</h3>
                <p>
              ...
              <div>
                <h3 className="text-2xl font-bold text-charcoal mb-4">What You Get</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold text-charcoal mb-4">What It Costs</h3>
                <p>Absolutely nothing. No fees, no hidden charges, no contracts.</p>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold text-charcoal mb-4">Why Now</h3>
                <p>
      ...
      <Dialog open={isVideoOpen} onOpenChange={setIsVideoOpen}>
        <DialogContent className="max-w-2xl w-[90vw] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[60] border-4 border-bone shadow-2xl">
