...
import owlMascotButton from '@/assets/owl-mascot-button.png';
    ...
    <>
      ...
      {!isOpen && (
          <button
            ...
            className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 rounded-full shadow-lg transition-all hover:scale-110 group"
