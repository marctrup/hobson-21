    ...
    <div className="space-y-8">
      ...
      <Card className="p-6 bg-gradient-to-br from-purple-50 to-white border-purple-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <h4 className="font-semibold text-foreground mt-4 mb-3">New Customers Added per Year</h4>
                  ...
                  <TableBody>
                    {[
                      ...
                      <TableRow key={row.year}>
                        ...
                        <TableCell className="text-right font-medium text-primary">{row.new}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
      ...
      <Card className="p-6 bg-gradient-to-br from-blue-50 to-white border-blue-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-3">Acquisition Spend (% of Revenue)</h3>
            <p className="text-muted-foreground mb-4">
              Only 2 cost areas directly contribute to customer acquisition:
            </p>
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="p-4 bg-blue-100/50 rounded-lg">
                <div className="text-lg font-bold text-blue-700">Digital Marketing</div>
                <div className="text-2xl font-bold text-foreground">8%</div>
                <div className="text-sm text-muted-foreground">of revenue</div>
              </div>
              <div className="p-4 bg-blue-100/50 rounded-lg">
                <div className="text-lg font-bold text-blue-700">Sales/SDR</div>
            ...
            <div className="p-4 bg-primary/10 rounded-lg border border-primary/20">
              <div className="text-center">
                <span className="text-sm text-muted-foreground">Total CAC Spend = </span>
                <span className="text-2xl font-bold text-primary">12% of Annual Revenue</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Card className="p-6 bg-gradient-to-br from-amber-50 to-white border-amber-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-4">Interpreting the CAC Trend</h3>
            
            <div className="space-y-4">
              <div className="p-4 bg-green-100/50 rounded-lg border-l-4 border-green-500">
                <h4 className="font-semibold text-green-800 mb-2">Early Years (2027–2028): Low CAC</h4>
              ...
              <div className="p-4 bg-amber-100/50 rounded-lg border-l-4 border-amber-500">
                <h4 className="font-semibold text-amber-800 mb-2">Middle Years (2029–2030): Modest Rise</h4>
                <ul className="space-y-1 text-sm text-amber-700">
                  <li>• CAC rises modestly as marketing becomes more competitive globally</li>
                </ul>
              </div>

              <div className="p-4 bg-orange-100/50 rounded-lg border-l-4 border-orange-500">
                <h4 className="font-semibold text-orange-800 mb-2">2031 Spike: Normal for Maturing SaaS</h4>
      ...
      <Card className="p-6 bg-gradient-to-br from-indigo-50 to-white border-indigo-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-3">CAC vs ARPU (LTV Comparison)</h3>
            
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="p-4 bg-indigo-100/50 rounded-lg">
                <div className="text-sm text-muted-foreground">ARPU</div>
                <div className="text-xl font-bold text-foreground">£495.72 / year</div>
              </div>
              <div className="p-4 bg-indigo-100/50 rounded-lg">
                <div className="text-sm text-muted-foreground">LTV (5-year lifetime)</div>
                <div className="text-xl font-bold text-foreground">£2,478.60</div>
              </div>
            </div>
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={row.year}>
                    ...
                    <TableCell className="text-right">{row.ltv}</TableCell>
                    <TableCell className="text-right font-bold text-indigo-600">{row.ratio}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
      ...
      <Card className="p-6 bg-gradient-to-br from-pink-50 to-white border-pink-200">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-3">CAC Payback Period</h3>
            
            <div className="p-3 bg-pink-100/50 rounded-lg mb-4">
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={row.year}>
                    <TableCell className="font-medium">{row.year}</TableCell>
                    <TableCell className="text-right">{row.cac}</TableCell>
                    <TableCell className="text-right font-bold text-pink-600">{row.payback}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
      ...
      <Card className="p-6 bg-gradient-to-br from-purple-100 to-purple-50 border-purple-300">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-foreground mb-4">CAC Assumption Summary</h3>
            
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Acquisition Spend Drivers</h4>
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">Calculated CAC</h4>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="p-4 bg-green-100/50 rounded-lg">
                  <h4 className="font-semibold text-green-800 mb-2">CAC Payback</h4>
                ...
                <div className="p-4 bg-indigo-100/50 rounded-lg">
                  <h4 className="font-semibold text-indigo-800 mb-2">LTV:CAC</h4>
