  ...
  return <div className="relative from-primary/5 to-secondary/10 rounded-2xl p-8 border border-primary/10 bg-paper">
      ...
      <div className="text-center mb-8">
        <h1 className="text-2xl leading-relaxed font-bold mb-2">
          <span className="text-ink-muted font-semibold">So many docs, one key date — here's how to find it</span>
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center relative">
        ...
        <div className="text-center lg:mt-[10px]">
          <div className="mb-4">
            ...
            <div className="text-xs text-ink-muted font-bold uppercase tracking-wide opacity-80">
          ...
          <div className="relative w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 mx-auto mb-4">
            <div className="absolute inset-0 border-2 border-dashed border-bone rounded-full animate-spin" style={{
        ...
        <div className="text-center lg:mt-[15px]">
          ...
          <div className="text-xs text-muted-foreground font-bold mt-3 space-y-1">
            ...
            <div className="whitespace-nowrap mt-2 text-success">
        ...
        <div className="text-center">
          <div className="mb-3">
            ...
            <div className="text-xs text-charcoal font-bold uppercase tracking-wide opacity-80">
