  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Hi {firstName}, Thank you for your interest in our exclusive pilot program! We're excited that you want to be part of the future of AI-powered property intelligence.
        </Text>
