...
export const getFinancialsExecutiveSummaryPdfContent = (): string[] => [
  ...
  "",
  "- Revenue growth from GBP 0.708M in 2027 to GBP 14.92M by 2031",
  "- ~90% five-year CAGR",
...
export const getFinancialsExecutiveSummaryStructuredData = () => ({
  ...
  fiveYearMetrics: [
    { label: "Revenue growth from GBP 0.708M in 2027 to GBP 14.92M by 2031", icon: "TrendingUp" },
