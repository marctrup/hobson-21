      ...
      return (
        <div className="flex-1">
          <div className="container mx-auto p-8 max-w-6xl mt-[10px]">
               ...
               {/* Description text below video - aligned with video right edge */}
               <div className="border-2 border-red-500 text-right" style={{ marginRight: 'calc(50% - 320px * 2.0736 / 2)', marginTop: 'calc(3rem + 70px)' }}>
                 <p className="text-lg text-muted-foreground max-w-3xl ml-auto">Hobson is an AI-powered assistant that reads and understands property documents to deliver accurate, cited answers instantly.</p>
               </div>
