  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        {/* Europe Side */}
        <div className="space-y-6 border-r-0 lg:border-r-2 border-border pr-0 lg:pr-6">
          <div className="sticky top-0 bg-background/95 backdrop-blur pb-3 border-b-2 border-primary/20">
        ...
        {/* Global Side */}
        <div className="space-y-6 pl-0 lg:pl-6">
          <div className="sticky top-0 bg-background/95 backdrop-blur pb-3 border-b-2 border-primary/20">
