  ...
  const tiers = [
    {
      ...
      features: () => [
        ...
        { text: `${t1.monthly_extractions} Documents read per month`, ok: true },
    ...
    },
    {
      ...
      features: () => [
        ...
        { text: "Plain English queries", ok: true },
        { text: "Sourced, auditable answers", ok: true },
        { text: `${t2.monthly_extractions} Documents read per month`, ok: true },
    ...
    },
    {
      ...
      features: () => [
        ...
        { text: "Plain English queries", ok: true },
        { text: "Sourced, auditable answers", ok: true },
        { text: `${t3.monthly_extractions} Documents read per month`, ok: true },
    ...
    },
    {
      ...
      features: () => [
        ...
        { text: "Plain English queries", ok: true },
        { text: "Sourced, auditable answers", ok: true },
        { text: `${t4.monthly_extractions} Documents read per month`, ok: true },
