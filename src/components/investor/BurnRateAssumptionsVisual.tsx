  ...
  return <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-purple-600/10 border-2 border-primary/30 rounded-xl p-6">
        ...
        <div className="bg-amber-50 dark:bg-amber-100 border border-amber-200 rounded-lg p-3 mt-4">
          <p className="text-sm text-black text-center">Key: The business avoids unnecessary dilution because the operating model is profitable from Year 1.<strong>Key:</strong> You avoid unnecessary dilution because the operating model is profitable from Year 1.
          </p>
        </div>
      </div>
