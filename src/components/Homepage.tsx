              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-4 lg:py-12 -mt-[5px]">
                ...
                <div className="relative mt-[5px]">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-gradient-to-b from-slate-300 via-slate-200 to-slate-100"></div>
                    
                    <div className="space-y-6">
                      {/* Item 1 */}
                      <div className="relative flex items-center gap-4 group">
                        <div className="relative z-10 w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center group-hover:bg-slate-200 transition-colors duration-300 shadow-sm">
                          <div className="w-2 h-2 bg-slate-400 rounded-full"></div>
                        </div>
                        <div className="flex-1 bg-gradient-to-r from-slate-50/80 to-transparent p-4 rounded-r-lg border-l-4 border-slate-200">
