            ...
            <div className="flex justify-between items-center">
              ...
              <div className="relative">
                <Link to="/" onClick={closeMobileMenu}>
                  <OptimizedImage src="/lovable-uploads/hobson-new-logo.png" alt="Hobson AI - AI-powered property management software company logo" className="h-[62px] w-auto" priority />
                </Link>
              </div>
          ...
          <footer className="py-5 md:py-16 border-t bg-white">
            <div className="container mx-auto px-4">
              <div className="grid md:grid-cols-3 gap-6 md:gap-12">
                {/* Logo */}
                <div>
                  <OptimizedImage src="/lovable-uploads/hobson-new-logo.png" alt="Hobson's AI logo" className="h-[62px] w-auto" />
                </div>
