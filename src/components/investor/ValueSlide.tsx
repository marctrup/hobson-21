  ...
  return (
    <div className="h-full flex items-center justify-center px-4 sm:px-6 pb-16 sm:pb-20">
      <div className="text-center max-w-2xl space-y-2 sm:space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4 py-2 sm:py-3 md:py-6">
          {values.map((item, idx) => (
        ...
        <p className="text-xs sm:text-sm md:text-base lg:text-xl text-primary leading-relaxed font-semibold max-w-xl mx-auto px-2">
