        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 py-2 sm:py-4">
          {problems.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center gap-1.5 sm:gap-2">
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 rounded-full bg-[#f1f5f9] flex items-center justify-center">
                <item.icon className="w-6 h-6 sm:w-7 sm:h-7 md:w-10 md:h-10 text-[#7c3aed]" />
              </div>
