  ...
  switch (componentType) {
    case "executiveSummary":
      return [
        ...
        "",
        "Hobson AI - Specialised AI for Real Estate:",
        "Turning complex documents and decisions into clear, reliable insight.",
        "Zero onboarding. Trusted accuracy from day one. Continuous learning that shifts",
        "from basic automation to proactive support - unlocking major efficiency gains",
        "across the entire property lifecycle.",
        "",
        "Addressable Market - Annual Efficiency Savings:",
        "- UK Savings: GBP 1.41B",
        "- European Savings: GBP 15.5B",
        "- Global Savings: GBP 155.6B",
        "",
        "Real estate professionals lose 20% of admin time to document chaos.",
        "These figures represent the annual savings Hobson can unlock - and the opportunity we're built to capture.",
        "",
        "Traction & Milestones:",
        "- MVP Launch Q1 2026 - Validated with 4 real-world partners",
        "- 98% Model Accuracy - Tested on real industry data",
        "- Multi-Document Support - Legal, compliance, operational reports",
        "- Domain-Trained AI - Built for reliability and depth",
        "",
        "Revenue Model:",
    ...
    case "approach":
      return [
        ...
        "- No licence fees, no per-user fees, no per-asset fees",
        "- Usage-based pricing via Hobson Energy Units (HEUs)",
        "- Full transparency - customers see exactly what Hobson did and why",
        "- Low base cost - frictionless entry",
        "- Flexible billing - high-volume market capture",
        "",
