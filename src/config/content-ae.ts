  ...
  pricing: {
    ...
    plans: {
      ...
      enterprise: {
        ...
        features: ["Everything in Essential, plus:", "Flexible document limits", "Flexible AI question limits", "Structured knowledge base", "Dedicated support", "Priority processing"],
