...
export const TargetMarketVisual = () => {
  return (
    <div className="w-full py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 p-8">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>• 235,200 UK real estate businesses</p>
              <p>• £6,000 annual efficiency saving per business</p>
              <p>• Based on verified ONS data</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 p-8">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>• 118× UK population multiple</p>
              <p>• Worldwide AI efficiency opportunity</p>
              <p>• Real estate document workflows</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 p-4 rounded-xl bg-muted/50 border">
        <p className="text-center text-sm text-muted-foreground">
          <span className="font-semibold text-foreground">Market Methodology:</span> UK TAM based on ONS-verified business counts (5.6M × 4.2% real estate share) and £30,000 junior salary benchmarks with 20% efficiency gain assumption.
        </p>
      </div>
    </div>
  );
...
export default TargetMarketVisual;
