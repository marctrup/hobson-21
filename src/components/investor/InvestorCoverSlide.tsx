...
export const InvestorCoverSlide = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full px-1">
      <div className="text-center text-xs sm:text-lg font-semibold text-foreground px-2 leading-tight border-2 border-red-500" style={{ marginTop: '25px', marginBottom: '8px' }}>
