              ...
              <>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <input type="text" placeholder="First name *" value={getStartedFirst} onChange={e => setGetStartedFirst(e.target.value)} className="rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2" style={{ border: `1px solid ${C.border}`, color: C.navy, background: '#ffffff', colorScheme: 'light' }} />
                    <input type="text" placeholder="Last name *" value={getStartedLast} onChange={e => setGetStartedLast(e.target.value)} className="rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2" style={{ border: `1px solid ${C.border}`, color: C.navy, background: '#ffffff', colorScheme: 'light' }} />
                  </div>
                  <input type="email" placeholder="Email *" value={getStartedEmail} onChange={e => setGetStartedEmail(e.target.value)} className="w-full rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2" style={{ border: `1px solid ${C.border}`, color: C.navy, background: '#ffffff', colorScheme: 'light' }} />
                  <input type="tel" placeholder="Phone (optional)" value={getStartedPhone} onChange={e => setGetStartedPhone(e.target.value)} className="w-full rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2" style={{ border: `1px solid ${C.border}`, color: C.navy, background: '#ffffff', colorScheme: 'light' }} />
                  <input type="text" placeholder="Company (optional)" value={getStartedCompany} onChange={e => setGetStartedCompany(e.target.value)} className="w-full rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2" style={{ border: `1px solid ${C.border}`, color: C.navy, background: '#ffffff', colorScheme: 'light' }} />
                </div>
